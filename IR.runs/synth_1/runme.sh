...
HD_PWD='C:/Users/Simone Ragoni/alice/InteractionRecord/InteractionRecord/IR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ir_statemachine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_ir_statemachine.tcl
